...
std::unique_ptr<Sav> SaveUtils::getSave(std::shared_ptr<uint8_t[]> dt, uint32_t length) {
	switch (length) {
		case 0x40000:
		case 0x4007A:
		case 0x8007A:
...
std::unique_ptr<Sav> SaveUtils::check080000(std::shared_ptr<uint8_t[]> dt, uint32_t length) {
